...
export const env = {
  ...
  COOKIE_SAMESITE: 'lax' as 'lax' | 'strict' | 'none',
  ...
  DB_CONFIG: {
    user: process.env.DB_USERNAME || 'abbey',
    password: process.env.DB_PASSWORD || 'abbey',
    host: process.env.DB_HOST || 'localhost',
    port: parseInt(process.env.DB_PORT || '5432', 10),
    database: process.env.DB_DATABASE || 'abbey_db'
  }
};
